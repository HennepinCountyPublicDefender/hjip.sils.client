...
@XmlRootElement(name = "SearchNameResult")
public class SearchNameResult {

    @XmlElement(name = "SubjectSummary")
    protected List<SearchNameResult.SubjectSummary> subjectSummary;
     ...
     * {@link SearchNameResult.SubjectSummary }
     * 
     * 
     */
    public List<SearchNameResult.SubjectSummary> getSubjectSummary() {
        if (subjectSummary == null) {
            subjectSummary = new ArrayList<SearchNameResult.SubjectSummary>();
        }
