 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element ref="{http://www.co.hennepin.mn.us/Justice/SILSServiceMessage}RequestSearchActivityID" minOccurs="0"/>
...
@XmlRootElement(name = "SearchActivityIDResult")
public class SearchActivityIDResult {

    @XmlElement(name = "SubjectSummary")
    protected List<SearchActivityIDResult.SubjectSummary> subjectSummary;
    @XmlElement(name = "RequestSearchActivityID")
    protected ActivityIdType requestSearchActivityID;
     ...
     * {@link SearchActivityIDResult.SubjectSummary }
     * 
     * 
     */
    public List<SearchActivityIDResult.SubjectSummary> getSubjectSummary() {
        if (subjectSummary == null) {
            subjectSummary = new ArrayList<SearchActivityIDResult.SubjectSummary>();
        }
     ...
     *     
     */
    public ActivityIdType getRequestSearchActivityID() {
        return requestSearchActivityID;
    }

    /**
     * Sets the value of the requestSearchActivityID property.
     * 
     * @param value
     *     allowed object is
     *     {@link ActivityIdType }
     *     
     */
    public void setRequestSearchActivityID(ActivityIdType value) {
        this.requestSearchActivityID = value;
    }
